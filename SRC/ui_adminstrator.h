...
public:
    ...
    void setupUi(QDialog *adminstrator)
    {
        ...
        removed_2->setObjectName(QString::fromUtf8("removed_2"));
        ...
        removed->setObjectName(QString::fromUtf8("removed"));
        removed->setGeometry(QRect(70, 320, 121, 28));
        addCourse1 = new QLineEdit(groupBox);
        addCourse1->setObjectName(QString::fromUtf8("addCourse1"));
        addCourse1->setGeometry(QRect(620, 230, 141, 28));
        removeCourse1 = new QLineEdit(groupBox);
        removeCourse1->setObjectName(QString::fromUtf8("removeCourse1"));
    ...
    {
        adminstrator->setWindowTitle(QApplication::translate("adminstrator", "Dialog", nullptr));
        groupBox->setTitle(QApplication::translate("adminstrator", "ADMINSTRATOR", nullptr));
        label->setText(QApplication::translate("adminstrator", "Adminstrator", nullptr));
        plus->setText(QApplication::translate("adminstrator", "Add user", nullptr));
        removed_2->setText(QApplication::translate("adminstrator", "Remove user", nullptr));
        addCourse->setText(QApplication::translate("adminstrator", "add course", nullptr));
        removeCourse->setText(QApplication::translate("adminstrator", "remove course", nullptr));
    } // retranslateUi
