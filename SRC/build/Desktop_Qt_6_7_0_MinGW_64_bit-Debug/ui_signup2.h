...
public:
    ...
    void setupUi(QDialog *Signup2)
    {
        ...
        label_12->setGeometry(QRect(50, 40, 141, 51));
        label_12->setFont(font);
        userId_4 = new QLineEdit(groupBox);
        userId_4->setObjectName("userId_4");
        userId_4->setGeometry(QRect(170, 50, 221, 31));
        userName_4 = new QLineEdit(groupBox);
        userName_4->setObjectName("userName_4");
        userName_4->setGeometry(QRect(200, 110, 221, 31));
        password_4 = new QLineEdit(groupBox);
        password_4->setObjectName("password_4");
        password_4->setGeometry(QRect(190, 180, 221, 31));
    ...
    void retranslateUi(QDialog *Signup2)
    {
        ...
        label_10->setText(QCoreApplication::translate("Signup2", "Username : ", nullptr));
